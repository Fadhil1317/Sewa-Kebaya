...
function App() {
  ...
  const categories = useMemo(() => {
    return ["Semua", ...new Set(dbProducts.map(p => p.category))].filter(Boolean);
  }, [dbProducts]);
      ...
      <div className="grow">
        <Routes>
          <Route path="/" element={
            <>
              <Hero />
              <main id="katalog-produk" className="container mx-auto px-6 py-20">
                <div className="flex flex-col items-center mb-12">
                  <h2 className="text-3xl font-serif text-stone-800 mb-6">Koleksi Pilihan</h2>
                ...
                {currentProducts.length > 0 ? (
                  ...
                  <div className="text-center py-20 italic text-stone-400">Model belum tersedia...</div>
                )}
              </main>
            </>
          } />
